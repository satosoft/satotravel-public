...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $user = \App\Models\User::where('email', 'admin@mytravel.test')->first();
        if(!is_demo_mode()){
        ...
        $user = \App\Models\User::where('email', 'vendor1@mytravel.test')->first();
        if(!is_demo_mode()){
            $user->need_update_pw = 1;
            $user->save();
        }
        ...
        $user = \App\Models\User::where('email', 'customer1@mytravel.test')->first();
        if(!is_demo_mode()){
            $user->need_update_pw = 1;
            $user->save();
        }
