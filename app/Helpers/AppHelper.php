...
function format_money($price){
   ...
   return App\Lib\Currency::format((float)$price);

}
function format_money_main($price){

   return App\Lib\Currency::format((float)$price,true);
...
function currency_symbol(){
    ...
    $currency = App\Lib\Currency::getCurrency($currency_main);
...
function recaptcha_field($action){
    return \App\Lib\ReCaptchaEngine::captcha($action);
}
...
{
    return App\Lib\Currency::getCurrent($need,$default);
}
