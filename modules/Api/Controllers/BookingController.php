...
class BookingController extends \Modules\Booking\Controllers\BookingController
{
    ...
    public function getConfigs(){
        ...
        $res = [
            ...
            'currency_main'=> \App\Lib\Currency::getCurrent('currency_main'),
    ...
    public function getCurrency(){
        $list = \App\Lib\Currency::getActiveCurrency();
        foreach ($list as &$item)
        {
            $currency = \App\Lib\Currency::getCurrency($item['currency_main']);
