            ...
            <div class="panel-body">
                <div class="form-group">
                    <div class="form-controls">
                        {!! \App\Lib\AdminForm::select('currency_main',\App\Lib\Currency::getAll(),$settings['currency_main'] ?? 'usd','dungdt-select2-field') !!}
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="form-controls">
                                {!! \App\Lib\AdminForm::select('currency_format',[
                                    ...
                                    <div class="item" data-number="{{$key}}">
                                        <div class="row">
                                            <div class="col-md-11">
                                                ...
                                                {!! \App\Lib\AdminForm::select('extra_currency['.$key.'][currency_main]',\App\Lib\Currency::getAll(),$item['currency_main'] ?? '','dungdt-select2-field') !!}
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label >{{__("Format")}}</label>
                                                            <div class="form-controls">
                                                                {!! \App\Lib\AdminForm::select('extra_currency['.$key.'][currency_format]',[
                                                                    ['id'=>'right','name'=>__('Right (100$)')],
                                                                    ['id'=>'right_space','name'=>__('Right with space (100 $)')],
                                                                    ['id'=>'left','name'=>__('Left ($100)')],
                                                                    ['id'=>'left_space','name'=>__('Left with space ($ 100)')],
                                    ...
                                    <div class="row">
                                        <div class="col-md-11">
                                            <div class="form-group">
                                                <label class="" >{{__("Sub Currency")}}</label>
                                                <div class="form-controls">
                                            {!! \App\Lib\AdminForm::select('extra_currency[__number__][currency_main]',\App\Lib\Currency::getAll(),'','dungdt-select2-field-lazy',true) !!}
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label >{{__("Format")}}</label>
                                                        <div class="form-controls">
                                                            {!! \App\Lib\AdminForm::select('extra_currency[__number__][currency_format]',[
                                                                ['id'=>'right','name'=>__('Right (100$)')],
                                                                ['id'=>'right_space','name'=>__('Right with space (100 $)')],
                                                                ['id'=>'left','name'=>__('Left ($100)')],
                                                                ['id'=>'left_space','name'=>__('Left with space ($ 100)')],
        ...
        @foreach($all as $k=>$gateway)
            ...
            <div class="panel">
                ...
                <div class="panel-body collapse" id="gateway_{{$k}}">
                    <div class="" >
                        @php App\Lib\AdminForm::generate($options); @endphp
                    </div>
                </div>
            </div>
        @endforeach
